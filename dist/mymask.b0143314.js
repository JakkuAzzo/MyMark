...
})({"hMnfo":[function(require,module,exports,__globalThis) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "86a7a44357d1fb02";
var HMR_USE_SSE = false;
module.bundle.HMR_BUNDLE_ID = "6d6e2bc5b0143314";
"use strict";
...
},{}],"awuAM":[function(require,module,exports,__globalThis) {
...
},{"vue":"cYOhs","./App.vue":"h2VCa","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"cYOhs":[function(require,module,exports,__globalThis) {
/**
* vue v3.5.13
...
const compile = ()=>{
    if (!!(process.env.NODE_ENV !== "production")) (0, _runtimeDom.warn)(`Runtime compilation is not supported in this build of Vue.` + ` Configure your bundler to alias "vue" to "vue/dist/vue.esm-bundler.js".`);
};

},{"@vue/runtime-dom":"ac8BQ","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"ac8BQ":[function(require,module,exports,__globalThis) {
/**
...
if (tt) try {
    ...
    !!(process.env.NODE_ENV !== "production") && (0, _runtimeCore.warn)(`Error creating trusted types policy: ${e}`);
}
...
function NumberOf(val) {
    ...
    if (!!(process.env.NODE_ENV !== "production")) (0, _runtimeCore.assertNumber)(res, "<transition> explicit duration");
    return res;
}
...
if (!!(process.env.NODE_ENV !== "production")) vShow.name = "show";
...
function useCssVars(getter) {
    ...
    if (!instance) {
        !!(process.env.NODE_ENV !== "production") && (0, _runtimeCore.warn)(`useCssVars is called without current active component instance.`);
        return;
    }
...
function patchDOMProp(el, key, value, parentComponent, attrName) {
    ...
    try {
        ...
        if (!!(process.env.NODE_ENV !== "production") && !needRemove) (0, _runtimeCore.warn)(`Failed setting prop "${key}" on <${tag.toLowerCase()}>: value ${value} is invalid.`, e);
    }
...
class VueElement extends BaseClass {
     ...
     */ this._nonce = this._def.nonce;
        ...
        if (this.shadowRoot && _createApp !== createApp) this._root = this.shadowRoot;
            ...
            if (!!(process.env.NODE_ENV !== "production") && this.shadowRoot) (0, _runtimeCore.warn)(`Custom element has pre-rendered declarative shadow root but is not defined as hydratable. Use \`defineSSRCustomElement\`.`);
   ...
   */ _resolveDef() {
        ...
        const resolve = (def, isAsync = false)=>{
            ...
            else if (!!(process.env.NODE_ENV !== "production") && styles) (0, _runtimeCore.warn)("Custom element style injection is not supported when using shadowRoot: false");
            this._mount(def);
        };
    ...
    _mount(def) {
        ...
        for(const key in exposed){
            if (!(0, _shared.hasOwn)(this, key)) Object.defineProperty(this, key, {
                // unwrap ref to be consistent with public instance behavior
                get: ()=>(0, _runtimeCore.unref)(exposed[key])
            });
            else if (!!(process.env.NODE_ENV !== "production")) (0, _runtimeCore.warn)(`Exposed property "${key}" already exists on custom element.`);
        }
    }
    _resolveProps(def) {
        const { props } = def;
...
function useCssModule(name = "$style") {
    {
        const instance = (0, _runtimeCore.getCurrentInstance)();
        if (!instance) {
            !!(process.env.NODE_ENV !== "production") && (0, _runtimeCore.warn)(`useCssModule must be called inside setup()`);
            return 0, _shared.EMPTY_OBJ;
        }
        const modules = instance.type.__cssModules;
        if (!modules) {
            !!(process.env.NODE_ENV !== "production") && (0, _runtimeCore.warn)(`Current instance does not have CSS modules injected.`);
            return 0, _shared.EMPTY_OBJ;
        }
        const mod = modules[name];
        if (!mod) {
            !!(process.env.NODE_ENV !== "production") && (0, _runtimeCore.warn)(`Current instance does not have CSS module named "${name}".`);
            return 0, _shared.EMPTY_OBJ;
        }
        return mod;
    }
    ...
    setup (props, { slots }) {
        ...
        return ()=>{
            ...
            for(let i = 0; i < children.length; i++){
                ...
                else if (!!(process.env.NODE_ENV !== "production") && child.type !== (0, _runtimeCore.Text)) (0, _runtimeCore.warn)(`<TransitionGroup> children must be keyed.`);
            }
...
function setSelected(el, value) {
    ...
    if (isMultiple && !isArrayValue && !(0, _shared.isSet)(value)) {
        !!(process.env.NODE_ENV !== "production") && (0, _runtimeCore.warn)(`<select multiple v-model> expects an Array or Set value for its binding, but got ${Object.prototype.toString.call(value).slice(8, -1)}.`);
        return;
    }
...
function normalizeContainer(container) {
    if ((0, _shared.isString)(container)) {
        ...
        if (!!(process.env.NODE_ENV !== "production") && !res) (0, _runtimeCore.warn)(`Failed to mount app: mount target selector "${container}" returned null.`);
        return res;
    }
    if (!!(process.env.NODE_ENV !== "production") && window.ShadowRoot && container instanceof window.ShadowRoot && container.mode === "closed") (0, _runtimeCore.warn)(`mounting on a ShadowRoot with \`{mode: "closed"}\` may lead to unpredictable bugs`);
    return container;
}
...
},{"@vue/runtime-core":"54wOH","@vue/shared":"bgNpD","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"54wOH":[function(require,module,exports,__globalThis) {
/**
...
function flushJobs(seen) {
    if (!!(process.env.NODE_ENV !== "production")) seen = seen || /* @__PURE__ */ new Map();
    const check = !!(process.env.NODE_ENV !== "production") ? (job)=>checkRecursiveUpdates(seen, job) : (0, _shared.NOOP);
    try {
...
if (!!(process.env.NODE_ENV !== "production")) (0, _shared.getGlobalThis)().__VUE_HMR_RUNTIME__ = {
...
function getInnerChild$1(vnode) {
    ...
    if (!!(process.env.NODE_ENV !== "production") && vnode.component) return vnode.component.subTree;
...
function useTemplateRef(key) {
    ...
    const ret = !!(process.env.NODE_ENV !== "production") ? (0, _reactivity.readonly)(r) : r;
...
Server rendered element contains more child nodes than client vdom.`);
  ...
  - expected on client: ${vnode.children}`);
            ...
            if (props) {
                ...
                else if (patchFlag & 4 && (0, _reactivity.isReactive)(props.style)) for(const key in props.style)props.style[key];
            }
            let vnodeHooks;
...
function defineAsyncComponent(source) {
    ...
    const load = ()=>{
        ...
        return pendingRequest || (thisRequest = pendingRequest = loader().catch((err)=>{
            ...
            if (!!(process.env.NODE_ENV !== "production") && comp && !(0, _shared.isObject)(comp) && !(0, _shared.isFunction)(comp)) throw new Error(`Invalid async component load result: ${comp}`);
            resolvedComp = comp;
            return comp;
        }));
    };
...
const KeepAliveImpl = {
    ...
    setup (props, { slots }) {
        ...
        let current = null;
        if (!!(process.env.NODE_ENV !== "production") || __VUE_PROD_DEVTOOLS__) instance.__v_cache = cache;
        ...
        sharedContext.activate = (vnode, container, anchor, namespace, optimized)=>{
            ...
            if (!!(process.env.NODE_ENV !== "production") || __VUE_PROD_DEVTOOLS__) devtoolsComponentAdded(instance2);
        };
...
If this is a native custom element, make sure to exclude it from component resolution via compilerOptions.isCustomElement.` : ``;
        ...
        return res;
    } else if (!!(process.env.NODE_ENV !== "production")) warn$1(`resolve${(0, _shared.capitalize)(type.slice(0, -1))} can only be used in render() or setup().`);
}
...
function toHandlers(obj, preserveCaseIfNecessary) {
    const ret = {};
    if (!!(process.env.NODE_ENV !== "production") && !(0, _shared.isObject)(obj)) {
...
/* @__PURE__ */ (0, _shared.extend)(/* @__PURE__ */ Object.create(null), {
    ...
    $el: (i)=>i.vnode.el,
    $data: (i)=>i.data,
    $props: (i)=>!!(process.env.NODE_ENV !== "production") ? (0, _reactivity.shallowReadonly)(i.props) : i.props,
    $attrs: (i)=>!!(process.env.NODE_ENV !== "production") ? (0, _reactivity.shallowReadonly)(i.attrs) : i.attrs,
    $slots: (i)=>!!(process.env.NODE_ENV !== "production") ? (0, _reactivity.shallowReadonly)(i.slots) : i.slots,
    $refs: (i)=>!!(process.env.NODE_ENV !== "production") ? (0, _reactivity.shallowReadonly)(i.refs) : i.refs,
...
const PublicInstanceProxyHandlers = {
    get ({ _: instance }, key) {
        ...
        if (publicGetter) {
            ...
            } else if (!!(process.env.NODE_ENV !== "production") && key === "$slots") (0, _reactivity.track)(instance, "get", key);
        ...
        else if (!!(process.env.NODE_ENV !== "production") && currentRenderingInstance && (!(0, _shared.isString)(key) || // #1091 avoid internal isRef/isVNode checks on component instance leading
    ...
    set ({ _: instance }, key, value) {
        ...
        if (hasSetupBinding(setupState, key)) {
            ...
            return true;
        } else if (!!(process.env.NODE_ENV !== "production") && setupState.__isScriptSetup && (0, _shared.hasOwn)(setupState, key)) {
...
function getContext() {
    const i = getCurrentInstance();
    if (!!(process.env.NODE_ENV !== "production") && !i) warn$1(`useContext() called without active instance.`);
...
function applyOptions(instance) {
    ...
    if (methods) for(const key in methods){
        ...
        if ((0, _shared.isFunction)(methodHandler)) {
            ...
            if (!!(process.env.NODE_ENV !== "production")) checkDuplicateProperties("Methods" /* METHODS */ , key);
    ...
    if (dataOptions) {
        if (!!(process.env.NODE_ENV !== "production") && !(0, _shared.isFunction)(dataOptions)) warn$1(`The data option must be a function. Plain object usage is no longer supported.`);
        const data = dataOptions.call(publicThis, publicThis);
        if (!!(process.env.NODE_ENV !== "production") && (0, _shared.isPromise)(data)) warn$1(`data() returned a Promise - note data() cannot be async; If you intend to perform data fetching before component renders, use async setup() + <Suspense>.`);
        if (!(0, _shared.isObject)(data)) !!(process.env.NODE_ENV !== "production") && warn$1(`data() should return an object.`);
        else {
    ...
    if (computedOptions) for(const key in computedOptions){
        ...
        if (!!(process.env.NODE_ENV !== "production") && get === (0, _shared.NOOP)) warn$1(`Computed property "${key}" has no getter.`);
        const set = !(0, _shared.isFunction)(opt) && (0, _shared.isFunction)(opt.set) ? opt.set.bind(publicThis) : !!(process.env.NODE_ENV !== "production") ? ()=>{
        ...
        if (!!(process.env.NODE_ENV !== "production")) checkDuplicateProperties("Computed" /* COMPUTED */ , key);
    }
...
function resolveInjections(injectOptions, ctx, checkDuplicateProperties = (0, _shared.NOOP)) {
    ...
    for(const key in injectOptions){
        ...
        if (!!(process.env.NODE_ENV !== "production")) checkDuplicateProperties("Inject" /* INJECT */ , key);
    }
}
...
If you want to remount the same app, move your app creation logic into a factory function and create fresh app instances for each mount - e.g. \`const createMyApp = () => createApp(App)\``);
            ...
            provide (key, value) {
                if (!!(process.env.NODE_ENV !== "production") && key in context.provides) warn$1(`App already provides property with key "${String(key)}". It will be overwritten with the new value.`);
...
function normalizePropsOptions(comp, appContext, asMixin = false) {
    ...
    if ((0, _shared.isArray)(raw)) for(let i = 0; i < raw.length; i++){
        if (!!(process.env.NODE_ENV !== "production") && !(0, _shared.isString)(raw[i])) warn$1(`props must be strings when using array syntax.`, raw[i]);
        ...
        if (!!(process.env.NODE_ENV !== "production") && !(0, _shared.isObject)(raw)) warn$1(`invalid props options`, raw);
...
function validateProps(rawProps, props, instance) {
    ...
    for(const key in options){
        ...
        validateProp(key, resolvedValues[key], opt, !!(process.env.NODE_ENV !== "production") ? (0, _reactivity.shallowReadonly)(resolvedValues) : resolvedValues, !camelizePropsKey.includes(key));
    }
}
...
const normalizeSlot = (key, rawSlot, ctx)=>{
    ...
    const normalized = withCtx((...args)=>{
        if (!!(process.env.NODE_ENV !== "production") && currentInstance && (!ctx || ctx.root === currentInstance.root)) warn$1(`Slot "${key}" invoked outside of the render function: this will not track dependencies used in the slot. Invoke the slot function inside the render function instead.`);
...
function baseCreateRenderer(options, createHydrationFns) {
    ...
    const patch = (n1, n2, container, anchor = null, parentComponent = null, parentSuspense = null, namespace, slotScopeIds = null, optimized = !!(process.env.NODE_ENV !== "production") && isHmrUpdating ? false : !!n2.dynamicChildren)=>{
        if (n1 === n2) return;
...
function traverseStaticChildren(n1, n2, shallow = false) {
    ...
    if ((0, _shared.isArray)(ch1) && (0, _shared.isArray)(ch2)) for(let i = 0; i < ch1.length; i++){
        ...
        if (!!(process.env.NODE_ENV !== "production") && c2.type === Comment && !c2.el) c2.el = c1.el;
    }
}
...
function watchPostEffect(effect, options) {
    return doWatch(effect, null, !!(process.env.NODE_ENV !== "production") ? (0, _shared.extend)({}, options, {
        flush: "post"
    }) : {
        flush: "post"
    });
...
function watch(source, cb, options) {
    if (!!(process.env.NODE_ENV !== "production") && !(0, _shared.isFunction)(cb)) warn$1(`\`watch(fn, options?)\` signature has been moved to a separate API. Use \`watchEffect(fn, options?)\` instead. \`watch\` now only supports \`watch(source, cb, options?) signature.`);
...
function renderComponentRoot(instance) {
    ...
    try {
        if (vnode.shapeFlag & 4) {
            ...
            result = normalizeVNode(render.call(thisProxy, proxyToUse, renderCache, !!(process.env.NODE_ENV !== "production") ? (0, _reactivity.shallowReadonly)(props) : props, setupState, data, ctx));
            fallthroughAttrs = attrs;
        } else {
            const render2 = Component;
            if (!!(process.env.NODE_ENV !== "production") && attrs === props) markAttrsAccessed();
            result = normalizeVNode(render2.length > 1 ? render2(!!(process.env.NODE_ENV !== "production") ? (0, _reactivity.shallowReadonly)(props) : props, !!(process.env.NODE_ENV !== "production") ? {
                get attrs () {
                    markAttrsAccessed();
                ...
                slots,
                emit
            }) : render2(!!(process.env.NODE_ENV !== "production") ? (0, _reactivity.shallowReadonly)(props) : props, null));
...
function _createVNode(type, props = null, children = null, patchFlag = 0, dynamicProps = null, isBlockNode = false) {
    ...
    if (!!(process.env.NODE_ENV !== "production") && shapeFlag & 4 && (0, _reactivity.isProxy)(type)) {
...
function cloneVNode(vnode, extraProps, mergeRef = false, cloneTransition = false) {
    ...
    const cloned = {
        ...
        children: !!(process.env.NODE_ENV !== "production") && patchFlag === -1 && (0, _shared.isArray)(children) ? children.map(deepCloneVNode) : children,
        target: vnode.target,
...
function setupStatefulComponent(instance, isSSR) {
    ...
    if (setup) {
        ...
        const setupResult = callWithErrorHandling(setup, instance, 0, [
            !!(process.env.NODE_ENV !== "production") ? (0, _reactivity.shallowReadonly)(instance.props) : instance.props,
            setupContext
        ]);
...
function finishComponentSetup(instance, isSSR, skipOptions) {
    ...
    if (!!(process.env.NODE_ENV !== "production") && !Component.render && instance.render === (0, _shared.NOOP) && !isSSR) {
...
const warn = !!(process.env.NODE_ENV !== "production") ? warn$1 : (0, _shared.NOOP);
...
},{"@vue/reactivity":"Vo0gV","@vue/shared":"bgNpD","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"Vo0gV":[function(require,module,exports,__globalThis) {
/**
...
class EffectScope {
   ...
   */ resume() {
    ...
    run(fn) {
        ...
        } else if (!!(process.env.NODE_ENV !== "production")) warn(`cannot run an inactive effect scope.`);
    }
    /**
   ...
   */ notify() {
    ...
    run() {
        ...
        try {
            ...
            if (!!(process.env.NODE_ENV !== "production") && activeSub !== this) warn("Active effect was not restored correctly - this is likely a Vue internal bug.");
            cleanupDeps(this);
...
class Dep {
    ...
    track(debugInfo) {
        ...
        if (!!(process.env.NODE_ENV !== "production") && activeSub.onTrack) activeSub.onTrack((0, _shared.extend)({
            effect: activeSub
        }, debugInfo));
        return link;
    }
...
function createReactiveObject(target, isReadonly2, baseHandlers, collectionHandlers, proxyMap) {
    if (!(0, _shared.isObject)(target)) {
        if (!!(process.env.NODE_ENV !== "production")) warn(`value cannot be made ${isReadonly2 ? "readonly" : "reactive"}: ${String(target)}`);
        return target;
    }
...
function toRefs(object) {
    if (!!(process.env.NODE_ENV !== "production") && !isProxy(object)) warn(`toRefs() expects a reactive object but received a plain one.`);
...
},{"@vue/shared":"bgNpD","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"bgNpD":[function(require,module,exports,__globalThis) {
/**
* @vue/shared v3.5.13
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"d6195":[function(require,module,exports,__globalThis) {
...
},{}],"h2VCa":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    ...
    script.__scopeId = 'data-v-967bb0';
    script.__file = "/Users/nathanbrown-bennett/mymask/src/App.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = '967bb0-hmr';
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord('967bb0-hmr', script)) __VUE_HMR_RUNTIME__.reload('967bb0-hmr', script);
        }, 0);
    });
}
exports.default = script;

},{"29158dae54139136":"6r3uc","8a4954974a3e2a08":"7qAuv","f5f81ab60053088e":"5H2K5","7e9898e9b122e745":"hNS4U","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"6r3uc":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _vue = require("vue");
var _dashboardVue = require("./components/Dashboard.vue");
...
var _matchesVue = require("./components/Matches.vue");
var _matchesVueDefault = parcelHelpers.interopDefault(_matchesVue);
var _statsVue = require("./components/Stats.vue");
var _statsVueDefault = parcelHelpers.interopDefault(_statsVue);
var _authVue = require("./components/Auth.vue");
var _authVueDefault = parcelHelpers.interopDefault(_authVue);
exports.default = {
    __name: 'App',
    setup (__props, { expose: __expose }) {
        __expose();
        const page = (0, _vue.ref)('dashboard');
        const __returned__ = {
            page,
            ref: (0, _vue.ref),
            Dashboard: (0, _dashboardVueDefault.default),
            Upload: (0, _uploadVueDefault.default),
            Matches: (0, _matchesVueDefault.default),
            Stats: (0, _statsVueDefault.default),
...
},{"vue":"cYOhs","./components/Dashboard.vue":"1tyNd","./components/Upload.vue":"6Y655","./components/Matches.vue":"i3CCH","./components/Stats.vue":"25BCs","./components/Auth.vue":"3GSCp","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"1tyNd":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require("ef67de559602c5c6");
    if (script.__esModule) script = script.default;
    script.render = require("ea439a6fc08fd450").render;
    require("23c937d5363895bd").default(script);
    script.__scopeId = 'data-v-cf82d5';
    script.__file = "/Users/nathanbrown-bennett/mymask/src/components/Dashboard.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = 'cf82d5-hmr';
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord('cf82d5-hmr', script)) __VUE_HMR_RUNTIME__.reload('cf82d5-hmr', script);
        }, 0);
    });
}
exports.default = script;

},{"ef67de559602c5c6":"a8C69","ea439a6fc08fd450":"gvuzh","23c937d5363895bd":"03qkT","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"a8C69":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = {
    __name: 'Dashboard',
    setup (__props, { expose: __expose }) {
        __expose();
        // No logic needed for a simple dashboard welcome
        const __returned__ = {};
        Object.defineProperty(__returned__, '__isScriptSetup', {
            enumerable: false,
            value: true
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"gvuzh":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_1, _cache[0] || (_cache[0] = [
        (0, _vue.createElementVNode)("h2", null, "Dashboard", -1 /* HOISTED */ ),
        (0, _vue.createElementVNode)("p", null, "Welcome to the MyMask Dashboard. Use the navigation to access features.", -1 /* HOISTED */ )
    ]));
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender('cf82d5-hmr', render);
});

},{"vue":"cYOhs","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"03qkT":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"6Y655":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require("32f64e71fc0372b2");
    if (script.__esModule) script = script.default;
    script.render = require("efa93722fa723f08").render;
    script.__cssModules = require("90f8944e32715a40").default;
    require("a0baa64468171941").default(script);
    script.__scopeId = 'data-v-1da637';
    script.__file = "/Users/nathanbrown-bennett/mymask/src/components/Upload.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = '1da637-hmr';
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord('1da637-hmr', script)) __VUE_HMR_RUNTIME__.reload('1da637-hmr', script);
        }, 0);
    });
}
exports.default = script;

},{"32f64e71fc0372b2":"laANz","efa93722fa723f08":"65aAl","90f8944e32715a40":"Vi9LB","a0baa64468171941":"c5GgE","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"laANz":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _vue = require("vue");
exports.default = {
    ...
    setup (__props, { expose: __expose }) {
        __expose();
        const selectedFile = (0, _vue.ref)(null);
        const uploadStatus = (0, _vue.ref)('');
        const downloadLink = (0, _vue.ref)(null);
        function handleFileChange(e) {
            if (e.target.files && e.target.files.length > 0) selectedFile.value = e.target.files[0];
        }
        async function handleUpload() {
            ...
            try {
                ...
                } else uploadStatus.value = 'Image upload failed.';
            } catch (err) {
        ...
        const __returned__ = {
            ...
            onUnmounted: (0, _vue.onUnmounted)
        };
        Object.defineProperty(__returned__, '__isScriptSetup', {
            enumerable: false,
            value: true
...
},{"vue":"cYOhs","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"65aAl":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_1, [
        _cache[1] || (_cache[1] = (0, _vue.createElementVNode)("h2", null, "Upload", -1 /* HOISTED */ )),
        _cache[2] || (_cache[2] = (0, _vue.createElementVNode)("p", {
            style: {
                "color": "red",
                "font-weight": "bold"
            }
        }, " Please ensure you only upload pictures of yourself. ", -1 /* HOISTED */ )),
        ...
        (0, _vue.createElementVNode)("p", null, (0, _vue.toDisplayString)($setup.uploadStatus), 1 /* TEXT */ ),
        $setup.downloadLink ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_3, [
            _cache[0] || (_cache[0] = (0, _vue.createElementVNode)("p", null, "Download your watermarked image:", -1 /* HOISTED */ )),
            (0, _vue.createElementVNode)("a", {
                href: $setup.downloadLink,
                target: "_blank",
                rel: "noreferrer",
                download: ""
            }, "Download", 8 /* PROPS */ , _hoisted_4)
        ])) : (0, _vue.createCommentVNode)("v-if", true),
        _cache[3] || (_cache[3] = (0, _vue.createStaticVNode)("<div style=\"display:flex;gap:20px;margin-top:20px;\" data-v-1da637><div style=\"flex:1;border:1px solid #ddd;padding:10px;border-radius:5px;\" data-v-1da637><h3 data-v-1da637>Generate Watermark</h3><div style=\"border:2px dashed #bbb;padding:20px;text-align:center;margin-bottom:10px;\" data-v-1da637><p data-v-1da637>Drop image here to fingerprint</p><input type=\"file\" accept=\"image/*\" style=\"width:100%;\" data-v-1da637></div><div style=\"margin-bottom:10px;\" data-v-1da637><button data-v-1da637>Check for Watermark</button></div><div style=\"margin-bottom:10px;\" data-v-1da637><p data-v-1da637>Download watermarked image:</p><a href=\"#\" download data-v-1da637>Download</a></div><div data-v-1da637><p data-v-1da637>Compare two images for watermark and likeness:</p><div style=\"display:flex;gap:5%;\" data-v-1da637><input type=\"file\" accept=\"image/*\" style=\"width:48%;\" data-v-1da637><input type=\"file\" accept=\"image/*\" style=\"width:48%;\" data-v-1da637></div><div style=\"margin-top:10px;\" data-v-1da637><p data-v-1da637>Similarity: [statistics]</p></div></div></div><div style=\"flex:1;border:1px solid #ddd;padding:10px;border-radius:5px;\" data-v-1da637><h3 data-v-1da637>Improve Likeness</h3><div style=\"border:2px dashed #bbb;padding:20px;text-align:center;\" data-v-1da637><p data-v-1da637>Drop additional images of yourself here</p><input type=\"file\" accept=\"image/*\" multiple style=\"width:100%;\" data-v-1da637></div><div style=\"margin-top:10px;\" data-v-1da637><p data-v-1da637>[Additional features to enhance likeness recognition]</p></div></div></div>", 1))
    ]);
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender('1da637-hmr', render);
});

},{"vue":"cYOhs","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"Vi9LB":[function() {},{}],"c5GgE":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"i3CCH":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require("f788d0abab0db509");
    if (script.__esModule) script = script.default;
    script.render = require("286a2b4bed36366a").render;
    require("4a2fcb5624adf2cc").default(script);
    script.__scopeId = 'data-v-c36bff';
    script.__file = "/Users/nathanbrown-bennett/mymask/src/components/Matches.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = 'c36bff-hmr';
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord('c36bff-hmr', script)) __VUE_HMR_RUNTIME__.reload('c36bff-hmr', script);
        }, 0);
    });
}
exports.default = script;

},{"f788d0abab0db509":"4aQ0y","286a2b4bed36366a":"eK0rJ","4a2fcb5624adf2cc":"7Ii1k","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"4aQ0y":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _vue = require("vue");
exports.default = {
    ...
    setup (__props, { expose: __expose }) {
        __expose();
        const matches = (0, _vue.ref)([]);
        const scanStatus = (0, _vue.ref)('');
...
},{"vue":"cYOhs","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"eK0rJ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_1, [
        _cache[2] || (_cache[2] = (0, _vue.createElementVNode)("h2", null, "Matches", -1 /* HOISTED */ )),
        (0, _vue.createElementVNode)("button", {
            onClick: $setup.handleScan
        }, "Scan Now"),
        (0, _vue.createElementVNode)("p", _hoisted_2, (0, _vue.toDisplayString)($setup.scanStatus), 1 /* TEXT */ ),
        $setup.matches.length ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_3, [
            _cache[0] || (_cache[0] = (0, _vue.createElementVNode)("h3", null, "Matches found:", -1 /* HOISTED */ )),
            (0, _vue.createElementVNode)("ul", null, [
                ((0, _vue.openBlock)(true), (0, _vue.createElementBlock)((0, _vue.Fragment), null, (0, _vue.renderList)($setup.matches, (match, idx)=>{
                    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("li", {
                        key: idx
                    }, [
                        (0, _vue.createElementVNode)("span", null, (0, _vue.toDisplayString)(match[0]), 1 /* TEXT */ ),
                        (0, _vue.createTextVNode)(" (distance: " + (0, _vue.toDisplayString)(match[1]) + ") ", 1 /* TEXT */ )
                    ]);
                }), 128 /* KEYED_FRAGMENT */ ))
            ])
        ])) : ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_4, _cache[1] || (_cache[1] = [
            (0, _vue.createElementVNode)("p", null, "No matches found yet.", -1 /* HOISTED */ )
        ])))
    ]);
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender('c36bff-hmr', render);
});

},{"vue":"cYOhs","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"7Ii1k":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"25BCs":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require("c37584f08ed8a5f3");
    if (script.__esModule) script = script.default;
    script.render = require("b55e285326b0e84d").render;
    require("c9d0766862d96c83").default(script);
    script.__scopeId = 'data-v-36e486';
    script.__file = "/Users/nathanbrown-bennett/mymask/src/components/Stats.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = '36e486-hmr';
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord('36e486-hmr', script)) __VUE_HMR_RUNTIME__.reload('36e486-hmr', script);
        }, 0);
    });
}
exports.default = script;

},{"c37584f08ed8a5f3":"kD63L","b55e285326b0e84d":"gBuPx","c9d0766862d96c83":"g00YT","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"kD63L":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _vue = require("vue");
exports.default = {
...
},{"vue":"cYOhs","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"gBuPx":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_1, [
        _cache[2] || (_cache[2] = (0, _vue.createElementVNode)("h2", null, "Statistics", -1 /* HOISTED */ )),
        (0, _vue.createElementVNode)("div", null, [
            (0, _vue.createElementVNode)("span", null, "Images tracked: " + (0, _vue.toDisplayString)($setup.stats.images), 1 /* TEXT */ ),
            _cache[0] || (_cache[0] = (0, _vue.createElementVNode)("br", null, null, -1 /* HOISTED */ )),
            (0, _vue.createElementVNode)("span", null, "Matches found: " + (0, _vue.toDisplayString)($setup.stats.matches), 1 /* TEXT */ ),
            _cache[1] || (_cache[1] = (0, _vue.createElementVNode)("br", null, null, -1 /* HOISTED */ )),
            (0, _vue.createElementVNode)("span", null, "Last scan: " + (0, _vue.toDisplayString)($setup.stats.last_scan || '-'), 1 /* TEXT */ )
        ]),
        (0, _vue.createElementVNode)("button", {
...
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender('36e486-hmr', render);
});

},{"vue":"cYOhs","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"g00YT":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"3GSCp":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    ...
    script.__scopeId = 'data-v-0c3422';
    script.__file = "/Users/nathanbrown-bennett/mymask/src/components/Auth.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = '0c3422-hmr';
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord('0c3422-hmr', script)) __VUE_HMR_RUNTIME__.reload('0c3422-hmr', script);
        }, 0);
    });
}
exports.default = script;

},{"97abe4167d4154c7":"110dS","aa2d29fa46974a54":"VoI2E","c23ae971db50237d":"4sbpF","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"110dS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _vue = require("vue");
exports.default = {
...
},{"vue":"cYOhs","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"VoI2E":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_1, [
        _cache[2] || (_cache[2] = (0, _vue.createElementVNode)("h2", null, "Auth", -1 /* HOISTED */ )),
        (0, _vue.createElementVNode)("div", null, [
        ...
        (0, _vue.createElementVNode)("p", null, (0, _vue.toDisplayString)($setup.status), 1 /* TEXT */ )
    ]);
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender('0c3422-hmr', render);
});

},{"vue":"cYOhs","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"4sbpF":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"7qAuv":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_1, [
        (0, _vue.createElementVNode)("nav", _hoisted_2, [
            (0, _vue.createElementVNode)("button", {
                onClick: _cache[0] || (_cache[0] = ($event)=>$setup.page = 'dashboard')
            }, "Dashboard"),
            (0, _vue.createElementVNode)("button", {
                onClick: _cache[1] || (_cache[1] = ($event)=>$setup.page = 'upload')
            }, "Upload"),
            (0, _vue.createElementVNode)("button", {
                onClick: _cache[2] || (_cache[2] = ($event)=>$setup.page = 'matches')
            }, "Matches"),
            (0, _vue.createElementVNode)("button", {
                onClick: _cache[3] || (_cache[3] = ($event)=>$setup.page = 'stats')
            }, "Stats"),
            (0, _vue.createElementVNode)("button", {
                onClick: _cache[4] || (_cache[4] = ($event)=>$setup.page = 'auth')
            }, "Auth")
        ]),
        $setup.page === 'dashboard' ? ((0, _vue.openBlock)(), (0, _vue.createBlock)($setup["Dashboard"], {
            key: 0
        })) : $setup.page === 'upload' ? ((0, _vue.openBlock)(), (0, _vue.createBlock)($setup["Upload"], {
            key: 1
        })) : $setup.page === 'matches' ? ((0, _vue.openBlock)(), (0, _vue.createBlock)($setup["Matches"], {
            key: 2
        })) : $setup.page === 'stats' ? ((0, _vue.openBlock)(), (0, _vue.createBlock)($setup["Stats"], {
            key: 3
        })) : $setup.page === 'auth' ? ((0, _vue.openBlock)(), (0, _vue.createBlock)($setup["Auth"], {
            key: 4
        })) : (0, _vue.createCommentVNode)("v-if", true)
    ]);
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender('967bb0-hmr', render);
});

},{"vue":"cYOhs","@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}],"5H2K5":[function() {},{}],"hNS4U":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"d6195"}]},["hMnfo","awuAM"], "awuAM", "parcelRequirea452", {})

//# sourceMappingURL=mymask.b0143314.js.map
